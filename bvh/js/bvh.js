...
BVH.Reader.prototype = {
    ...
    transposeName:function( name ){
        ...
        if(name==="Hips") name = "noHips";
        if(name==="hip" || name==="SpineBase") name = "Hips";  //髋部
        
        if(name==="chest" || name==="SpineMid" || name==="Spine1") name = "Chest";  //胸口
        if(name==="abdomen" || name==="SpineBase2"||name==="Spine") name = "Spine1"; //腹部
        if(name==="lThigh"||name==="LeftUpLeg") name = "LeftUpLeg";
        if(name==="rThigh"||name==="RightUpLeg") name = "RightUpLeg";
        
        if(name==="lShin"||name==="LeftLeg") name = "LeftLowLeg";
        if(name==="rShin"||name==="RightLeg") name = "RightLowLeg";

        if(name==="lFoot"||name==="LeftFoot") name = "LeftFoot";
        if(name==="rFoot"||name==="RightFoot") name = "RightFoot";

        if(name==="rtoes"||name==="RightToeBase") name = "RightToe";
        if(name==="ltoes"|name==="LeftToeBase") name = "LeftToe";

		if(name==="Neck") name = "noNeck";
        if(name==="neck" ) name = "Neck"; //脖子
        if(name==="head"|| name==="Head") name = "Head";  //头
        if(name==="lCollar"||name==="LeftShoulder") name = "LeftCollar";
        if(name==="rCollar"|| name==="RightShoulder") name = "RightCollar";
        if(name==="lShldr"|| name==="LeftArm") name = "LeftUpArm";
        if(name==="rShldr"|| name==="RightArm") name = "RightUpArm";
        if(name==="lForeArm"||name==="LeftForeArm") name = "LeftLowArm";
        if(name==="rForeArm"||name==="RightForeArm") name = "RightLowArm";
        if(name==="RightHand") name = "noRightHand";
        if(name==="LeftHand") name = "noLeftHand";
        if(name==="lHand"||name==="LeftFingerBase") name = "LeftHand";
        if(name==="rHand"||name==="RightFingerBase") name = "RightHand";
